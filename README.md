...
Enterprise SaaS Stack Signal Benchmark is a Kinetic Gain benchmark-pack repo for enterprise platform and company signals.
...
`json
{
  "product": "Enterprise SaaS Stack Signal Benchmark",
